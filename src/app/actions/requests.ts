...
// import { revalidatePath } from 'next/cache';            // <- fix import
...
//   if (updErr) redirect('/chats?error=' + encodeURIComponent(updErr.message));

//   await supabase
//     .from('chats')
//     .upsert({ request_id: requestId, is_open: true }, { onConflict: 'request_id' });
...
//       sender_id: user.id,
//       kind: 'system',
//       body: 'Request accepted. Chat opened.',
//     });
//   }
